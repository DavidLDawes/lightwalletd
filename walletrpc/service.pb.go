...
var file_service_proto_rawDesc = []byte{
	...
	0x6e, 0x74, 0x65, 0x72, 0x76, 0x61, 0x6c, 0x55, 0x73, 0x22, 0x30, 0x0a, 0x12, 0x47, 0x65, 0x74,
	...
	0x09, 0x52, 0x08, 0x69, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x22, 0x38, 0x0a, 0x0c, 0x50,
	...
	0x20, 0x01, 0x28, 0x03, 0x52, 0x08, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x5a, 0x61, 0x74, 0x32, 0x8f,
	0x08, 0x0a, 0x11, 0x43, 0x6f, 0x6d, 0x70, 0x61, 0x63, 0x74, 0x54, 0x78, 0x53, 0x74, 0x72, 0x65,
	...
	0x61, 0x6e, 0x63, 0x65, 0x22, 0x00, 0x28, 0x01, 0x12, 0x62, 0x0a, 0x0b, 0x47, 0x65, 0x74, 0x49,
	0x64, 0x65, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x12, 0x29, 0x2e, 0x63, 0x61, 0x73, 0x68, 0x2e, 0x7a,
	...
	0x73, 0x74, 0x1a, 0x26, 0x2e, 0x63, 0x61, 0x73, 0x68, 0x2e, 0x7a, 0x2e, 0x77, 0x61, 0x6c, 0x6c,
	0x65, 0x74, 0x2e, 0x73, 0x64, 0x6b, 0x2e, 0x72, 0x70, 0x63, 0x2e, 0x49, 0x64, 0x65, 0x6e, 0x74,
	0x69, 0x74, 0x79, 0x50, 0x72, 0x69, 0x6d, 0x61, 0x72, 0x79, 0x22, 0x00, 0x12, 0x52, 0x0a, 0x0d,
	...
	0x42, 0x0d, 0x5a, 0x0b, 0x2e, 0x3b, 0x77, 0x61, 0x6c, 0x6c, 0x65, 0x74, 0x72, 0x70, 0x63, 0x62,
...
var file_service_proto_goTypes = []interface{}{
	...
	(*GetIdentityRequest)(nil),            // 10: cash.z.wallet.sdk.rpc.GetIdentityRequest
	...
	(*IdentityPrimary)(nil),               // 16: cash.z.wallet.sdk.rpc.IdentityPrimary
}
var file_service_proto_depIdxs = []int32{
	...
	13, // 10: cash.z.wallet.sdk.rpc.CompactTxStreamer.GetTaddressBalance:input_type -> cash.z.wallet.sdk.rpc.AddressList
	12, // 11: cash.z.wallet.sdk.rpc.CompactTxStreamer.GetTaddressBalanceStream:input_type -> cash.z.wallet.sdk.rpc.Address
	10, // 12: cash.z.wallet.sdk.rpc.CompactTxStreamer.GetIdentity:input_type -> cash.z.wallet.sdk.rpc.GetIdentityRequest
	...
	14, // 21: cash.z.wallet.sdk.rpc.CompactTxStreamer.GetTaddressBalance:output_type -> cash.z.wallet.sdk.rpc.Balance
	14, // 22: cash.z.wallet.sdk.rpc.CompactTxStreamer.GetTaddressBalanceStream:output_type -> cash.z.wallet.sdk.rpc.Balance
	16, // 23: cash.z.wallet.sdk.rpc.CompactTxStreamer.GetIdentity:output_type -> cash.z.wallet.sdk.rpc.IdentityPrimary
	7,  // 24: cash.z.wallet.sdk.rpc.CompactTxStreamer.GetLightdInfo:output_type -> cash.z.wallet.sdk.rpc.LightdInfo
	11, // 25: cash.z.wallet.sdk.rpc.CompactTxStreamer.Ping:output_type -> cash.z.wallet.sdk.rpc.PingResponse
...
type CompactTxStreamerClient interface {
	...
	// Identity
	GetIdentity(ctx context.Context, in *GetIdentityRequest, opts ...grpc.CallOption) (*IdentityPrimary, error)
...
func (c *compactTxStreamerClient) GetIdentity(ctx context.Context, in *GetIdentityRequest, opts ...grpc.CallOption) (*IdentityPrimary, error) {
	out := new(IdentityPrimary)
...
type CompactTxStreamerServer interface {
	...
	// Identity
	GetIdentity(context.Context, *GetIdentityRequest) (*IdentityPrimary, error)
	// Return information about this lightwalletd instance and the blockchain
...
func (*UnimplementedCompactTxStreamerServer) GetIdentity(context.Context, *GetIdentityRequest) (*IdentityPrimary, error) {
