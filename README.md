...
```
With Identiy support, you can query identities:
```
grpcurl --cacert cert.pem  -d '{"identity": "DavidLDawes@"}' localhost:18232  vrsc.wallet.sdk.rpc.CompactTxStreamer.GetIdentity
{
  "identityinfo": {
    "identity": {
      "name": "DavidLDawes"
    ...
    "status": "active",
    "blockheight": "863103",
    "txid": "8f060c64359eaeac0b1676525403f2a4db339cf48045c11d11b0de4fe971e59b"
  }
}
```
