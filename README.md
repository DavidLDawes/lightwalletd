...
You can generate the gohash.go and gohash_wrap.cxx files from the gohash/gohash.i file via this swig command: 
```
 swig -go  -intgosize 64 -c++ -cgo -Wall -v parser/gohash/gohash.i
```
